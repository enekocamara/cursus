...
/*   Updated: 2022/01/11 11:03:33 by ecamara          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_frame3(t_data *data, int x, int y)
{
	...
	else if (data->asset_map[ft_ix(x, y, data->max_x)] == 'Z')
		mlx_put_image_to_window(data->mlx, data->win,
			data->tiles[ft_ix(x, y, data->max_x)], x * 50, y * 50 + 50);
...
void	ft_frame2(t_data *data, int x, int y)
{
	...
	p = 50;
	if (data->asset_map[ft_ix(x, y, data->max_x)] == 'z')
	{
		img = mlx_xpm_file_to_image(data->mlx, "obj/enemy-1.xpm", &p, &p);
		mlx_put_image_to_window(data->mlx, data->win, img, x * 50 + 12,
			y * 50 + 12 + 50);
	}
	else if (data->asset_map[ft_ix(x, y, data->max_x)] == 'x')
	{
		img = mlx_xpm_file_to_image(data->mlx, "obj/enemy-2.xpm", &p, &p);
		mlx_put_image_to_window(data->mlx, data->win, img, x * 50 + 12,
			y * 50 + 12 + 50);
	}
	else if (data->asset_map[ft_ix(x, y, data->max_x)] == 'X')
	{
		img = mlx_xpm_file_to_image(data->mlx, "obj/enemy-3.xpm", &p, &p);
		mlx_put_image_to_window(data->mlx, data->win, img, x * 50 + 12,
			y * 50 + 12 + 50);
	}
	else
